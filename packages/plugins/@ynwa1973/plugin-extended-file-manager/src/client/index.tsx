...
import {
  ...
  STORAGE_TYPE_S3,
  STORAGE_TYPE_TX_COS,
  STORAGE_TYPE_ORACLE_OSS,
} from '../constants';
import { OracleFileManagerProvider } from './OracleFileManagerProvider';
import { FileSizeField } from './FileSizeField';
import { OracleFileStoragePane } from './FileStorage';
...
export class PluginFileManagerClient extends Plugin {
  ...
  async load() {
    ...
    this.app.use(OracleFileManagerProvider);
    this.app.pluginSettingsManager.add(NAMESPACE, {
      title: `{{t("Extended file manager", { ns: "${NAMESPACE}" })}}`,
      icon: 'FileOutlined',
      Component: OracleFileStoragePane,
      aclSnippet: 'pm.oracle-file-manager.storages',
    });
  ...
  async uploadFile(options?: {
    ...
    console.log('[DEBUG]: Storage type: ', storageTypeObj);
